...
# --- CRIAR POSTER (MODIFICADO PARA ESTILO POLAROID SEM BORDAS E COM AJUSTE DE TÍTULO) ---
def create_poster(anime):
    ...
    try:
        ...
        print("Aviso: Fonte 'arialbd.ttf' ou 'arial.ttf' não encontrada. Usando fonte padrão.")
    ...
    # --- Lógica responsiva para o título e ano ---
    ...
    # Desenha o Ano apenas se existir
    if year:
        draw.text(
...
print(" Bot iniciado! Postando agora e a cada 1h...")
